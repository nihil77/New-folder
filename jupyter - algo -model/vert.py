...
while cap is not None and cap.isOpened():
    ...
    if results.pose_landmarks is not None:
        ...
        # Display the angle guide text with custom font and text color
        guide_text_color = (0, 255, 0) if is_correct_horse_stance else (0, 0, 255)
    ...
    # Display the frame
    cv2.imshow("Horse Stance Monitoring", frame)
